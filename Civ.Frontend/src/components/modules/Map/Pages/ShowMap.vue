        ...
        <div id="actionMenu" class="col-lg-3 col-md-4 col-sm-6">
            ...
            <div id="bottomMenu">
                <div>
                    ...
                    <button @click="this.$router.push({ name: 'arena', params: { id: this.selectedCell.unit.id }})">
                        Arena
                    </button>
                    <button @click="createCommander">
                        Create Commander
                    </button>
                </div>
                <div>
...
import Hero from '../Models/Unit.js'
...
export default {
    ...
    async mounted() {
        ...
        if (this.$route.params.id) {
            ...
            this.cellArray[5][5].unit = new Hero(UnitType.Hero, "Jacek", 1);
        }
    },
    ...
    methods: {
        ...
        createCommander() {
            var index = this.commanderList ? this.commanderList.length +1 : 1;
            var commander = new Hero("Friendly", "Jeff", "Blue", index);
            this.commanderList.push(commander);
        }
    }
}
</script>